        ...
        function () {
            ...
            function () {
                ...
                function () {
                    ...
                    s3ui.ensureData(self, uuid, pwe + 1, startTime - sideCache, endTime + sideCache, function () { s3ui.setStreamMessage(self, uuid, undefined, 1); }, true);
                }, true);
            }, true);
        }, true);
}
...
function repaintZoomNewData(self, callback, stopCache, widthEstimate) {
  ...
  function makeDataCallback(stream, startTime, endTime) {
        return function (data, low, high) {
            ...
            if (!stopCache) {
                s3ui.setStreamMessage(self, stream.uuid, "Prefetching data...", 1);
...
function updateSize(self, redraw) {
    ...
    self.idata.xLegend.setAttribute("x", WIDTH+28);
